...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "upstream_request_bytes", Type: field.TypeInt64, Default: 0},
		{Name: "upstream_response_bytes", Type: field.TypeInt64, Default: 0},
		{Name: "traffic_source", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "traffic_estimated", Type: field.TypeBool, Default: false},
		{Name: "image_count", Type: field.TypeInt, Default: 0},
