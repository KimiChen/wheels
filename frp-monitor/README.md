...
> 状态：P3 已落地，2026-09-26 更新。采集、上报、探测、历史、流量、隧道对账、
> 凭据管理、备份与发布打包均已实现；`scripts/verify.sh` 覆盖基线/扩展双标签、
> 端到端冒烟（含混排兼容与重启恢复）、交叉编译与 100 节点容量档。后续规划项
> （告警、价格/到期、远程 Proxy CRUD 等）见 §9 末段。
